...
const FormAddStaff = () => {
  ...
  const [staffAllocationLevelTBId, setStaffAllocationLevelTBId] = useState("");
  ...
  useEffect(() => {
    ...
    if (token) {
      ...
      axios
        .get("http://172.25.160.235:2402/staff_allocation_levelTB", {
          headers: {
            Authorization: authHeader,
          },
        })
  ...
  const handleAuditStaff = async () => {
    ...
    const action = `Add staff info ${MSISDN}`;
              ...
              {/* <div className="field">
                ...
                <div className="control">
                  <select
                    ...
                    onChange={(e) =>
                      setStaffAllocationLevelTBId(e.target.value)
                    }
                  >
